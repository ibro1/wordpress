...
function wookiee_render_setup_wizard_page() {
	...
	<div class="wrap">
		...
		<div class="wookiee-setup-step" data-step-panel="shipping" hidden>
			...
			<?php wookiee_render_settings_fields_table( array( 'shipping_rate', 'shipping_dispatch', 'handling_time', 'transit_time', 'estimated_delivery', 'dispatch_origin', 'shipping_carriers', 'payment_methods', 'returns_address', 'returns_period_days', 'cancellation_period', 'restocking_fee' ) ); ?>
			<p>
