...
<main class="site-main">
	...
	<!-- Hero Section -->
	<section class="hero-section" style="background-color: var(--wookiee-bg); padding: 50px 20px; font-family: var(--font-primary); box-sizing: border-box;">
		<div class="container hero-grid" style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1.2fr 1fr; gap: 40px; align-items: center; box-sizing: border-box;">
			<div class="hero-text-col" style="text-align: left; box-sizing: border-box;">
				...
				<h1 style="font-size: 48px; color: var(--wookiee-navy); margin: 0 0 20px 0; font-weight: 800; letter-spacing: -2px; line-height: 1.1;">A more organised<br>home starts <span>here.</span></h1>
			...
			<div class="hero-image-col" style="position: relative;">
				...
				if ( $hero_url ) :
				?>
				<img src="<?php echo esc_url($hero_url); ?>" alt="Wookiee Storage Shelving" style="border-radius: 20px; width: 100%; max-height: 400px; object-fit: cover; box-shadow: 0 20px 40px rgba(0,0,0,0.08); display: block;">
				<?php else : ?>
	...
	<!-- Features Section -->
	<section class="features-section" style="padding: 50px 20px; background: var(--wookiee-white); display: flex; justify-content: center; gap: 60px; border-bottom: 1px solid var(--wookiee-border); flex-wrap: wrap;">
		<div class="feature-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 180px;">
			...
			<div style="font-weight: 700; color: var(--wookiee-navy); font-size: 15px; margin-bottom: 4px;">Free delivery</div>
		...
		<div class="feature-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 180px;">
			...
			<div style="font-weight: 700; color: var(--wookiee-navy); font-size: 15px; margin-bottom: 4px;">30 day returns</div>
		...
		<div class="feature-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; max-width: 180px;">
			...
			<div style="font-weight: 700; color: var(--wookiee-navy); font-size: 15px; margin-bottom: 4px;">Secure payments</div>
						...
						<div class="product-card">
							...
							<div class="product-content-wrapper" style="padding: 20px; display: flex; flex-direction: column; flex-grow: 1; text-align: left; box-sizing: border-box;">
								<h3 style="margin: 0 0 8px 0; font-size: 16px; font-weight: 700; line-height: 1.4; min-height: 44px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
									<a href="<?php the_permalink(); ?>" style="text-decoration: none; color: var(--wookiee-navy); transition: color 0.2s;"><?php the_title(); ?></a>
								</h3>
								...
								<div style="font-size: 18px; font-weight: 800; color: var(--wookiee-navy); margin-bottom: 15px;">
		...
		<div>
			...
			<div style="display: flex; flex-direction: column; gap: 20px;">
				<div style="display: flex; gap: 15px; align-items: flex-start;">
					<div style="background: var(--wookiee-navy); color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">1</div>
				...
				<div style="display: flex; gap: 15px; align-items: flex-start;">
					<div style="background: var(--wookiee-navy); color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">2</div>
				...
				<div style="display: flex; gap: 15px; align-items: flex-start;">
					<div style="background: var(--wookiee-navy); color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">3</div>
	...
	<!-- Simple Text Section -->
	<section style="background: var(--wookiee-white); padding: 80px 20px; text-align: center;">
