                ...
                <div>
                    ...
                    <div class="contact-info-card">
                        ...
                        <div>
                            ...
                            <p class="contact-info-desc">[wookiee_field key="support_hours"]</p>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">2. Placing an Order</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">3. Prices and Payment</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">4. Delivery</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">6. Faulty or Incorrect Goods</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">8. Limitation of Liability</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">9. Intellectual Property</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">11. Governing Law</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">12. Changes to These Terms</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Where We Deliver</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Delivery Options and Costs</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Order Processing</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Delivery Timescales</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Failed Deliveries</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Our 30-Day Commercial Returns Policy</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Faulty, Damaged or Incorrect Items</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Non-Returnable Items</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Accepted Payment Methods</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">When You Are Charged</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Payment Security</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Currency</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Fraud Prevention</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">1. Who We Are (Data Controller)</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">2. What Information We Collect</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">3. How We Use Your Information</h2>
<table style="width:100%; border-collapse:collapse; font-size:14px; margin-bottom:20px;">
  <thead>
    <tr style="background:#ece2d3;">
      <th style="text-align:left; padding:12px 16px; color:#1a1614;">Purpose</th>
      <th style="text-align:left; padding:12px 16px; color:#1a1614;">Lawful Basis (UK GDPR Art.6)</th>
    </tr>
  </thead>
  <tbody>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">4. Who We Share Your Information With</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">5. Data Retention</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">7. Your Rights</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">8. How We Keep Your Data Secure</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">9. International Transfers</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">12. Changes to This Policy</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">What Are Cookies?</h2>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Cookies We Use</h2>

<h3 style="font-size:17px; font-weight:700; color:#1a1614; margin-bottom:8px;">1. Strictly Necessary Cookies</h3>
...
<table style="width:100%; border-collapse:collapse; font-size:14px; margin-bottom:24px;">
  <thead>
    <tr style="background:#ece2d3;">
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Cookie name</th>
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Purpose</th>
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Duration</th>
    </tr>
  </thead>
  <tbody>
    <tr style="border-bottom:1px solid #e5dbc9;">
...
<h3 style="font-size:17px; font-weight:700; color:#1a1614; margin-bottom:8px;">2. Analytics Cookies</h3>
...
<table style="width:100%; border-collapse:collapse; font-size:14px; margin-bottom:24px;">
  <thead>
    <tr style="background:#ece2d3;">
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Cookie name</th>
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Provider</th>
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Purpose</th>
      <th style="text-align:left; padding:10px 14px; color:#1a1614;">Duration</th>
    </tr>
  </thead>
...
<h3 style="font-size:17px; font-weight:700; color:#1a1614; margin-bottom:8px;">3. Marketing and Advertising Cookies</h3>
...
<h2 style="font-size:20px; font-weight:700; color:#1a1614; margin-bottom:12px;">Changes to This Policy</h2>
...
<h1 style="font-size:32px; font-weight:800; color:#1a1614; margin-bottom:6px;">Cookie Preferences</h1>
<p style="color:#8a7d6d; font-size:14px; margin-bottom:40px;">Wookiee Decor Ltd &nbsp;|&nbsp; wookied.com</p>
    ...
    foreach ( $dummy_products as $prod ) {
        ...
        if ( ! $existing ) {
            ...
            if ( $post_id && ! is_wp_error( $post_id ) ) {
                ...
                // Additional gallery images (product page thumbnail strip)
                if ( ! empty( $prod['gallery'] ) ) {
                    $gallery_ids = wookiee_sideload_gallery_images( $prod['gallery'], $prod['title'] );
                    if ( $gallery_ids ) {
            ...
            // Same repair pattern for the gallery, in case this product was
            // created before gallery images were part of the setup.
            $gallery_meta = get_post_meta( $existing->ID, '_product_image_gallery', true );
            if ( ! $gallery_meta && ! empty( $prod['gallery'] ) ) {
                $gallery_ids = wookiee_sideload_gallery_images( $prod['gallery'], $prod['title'] );
                if ( $gallery_ids ) {
                    update_post_meta( $existing->ID, '_product_image_gallery', implode( ',', $gallery_ids ) );
                }
            }
        }
    }
...
/**
 * Sideload a list of theme image filenames and return their attachment IDs,
 * for use as a WooCommerce product's image gallery.
 */
function wookiee_sideload_gallery_images( array $filenames, $title ) {
    $ids = array();
    foreach ( $filenames as $filename ) {
        $attach_id = wookiee_sideload_theme_image( $filename, $title . ' (gallery)' );
        if ( $attach_id ) {
            $ids[] = $attach_id;
        }
    }
