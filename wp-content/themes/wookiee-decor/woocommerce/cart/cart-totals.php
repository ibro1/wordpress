<?php
/**
 * Wookiee Decor - Custom Cart Totals Template
...
?>
<div class="wookiee-cart-totals">

    <h3 class="wookiee-totals-title">Order Summary</h3>
    ...
    <div class="wookiee-totals-rows">
        ...
        <div class="wookiee-totals-row wookiee-coupon-row">
            <span class="label coupon-code-label">
                ...
                <a href="<?php echo esc_url( add_query_arg( 'remove_coupon', rawurlencode( $code ), wc_get_cart_url() ) ); ?>" class="wookiee-remove-coupon" data-coupon="<?php echo esc_attr( $code ); ?>">&times;</a>
            </span>
        ...
        <div class="wookiee-totals-row wookiee-shipping-row">
    ...
    <!-- Grand Total -->
    <div class="wookiee-totals-grand">
        <div>
    ...
    <!-- Checkout CTA -->
    <div class="wookiee-checkout-cta">
        <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="wookiee-checkout-btn">
            Proceed to Checkout
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
        </a>
        <a href="<?php echo esc_url( wc_get_page_permalink('shop') ); ?>" class="wookiee-continue-link">
            &larr; Continue Shopping
        </a>
    </div>

    <!-- Payment Icons -->
    <div class="wookiee-payment-icons">
