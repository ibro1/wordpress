...
class ExportCommand extends MUMigrationBase {
	...
	public static function getCSVHeaders() {
		 ...
		 *
		 * @since 0.1.0
		 * @param array $custom_headers The custom headers array.
		 * @return array                Array data headers.
		 */
		$custom_headers = apply_filters('mu_migration/export/user/headers', []);
	...
	public function users($args = [], $assoc_args = [], $verbose = true) {
		...
		foreach ( $users as $user ) {
			 ...
			 * @since 0.1.0
			 *
			 * @param array    $custom_user_data The custom user data array.
